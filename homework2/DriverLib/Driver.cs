...
namespace DriverLib
{
    public class Driver
    {
        ...
        [JsonIgnore] // to handle ratings separatly in file management
        ...
        {
            string ratingsString = ""; // converting ratings list to comma separated string
            foreach (var rating in ratings)
            {
                ratingsString = $"{ratingsString},{rating}";
            }
            return $"{driverId},{name},{age},{gender},{address},{phoneNo},{currentLocation},{vehicle}{ratingsString}";
        }
    }
}